...
public class JwtTokenProvider
{
    ...
    private static Key getPrivateKey() throws Exception
    {
       ...
       // File file = new File(classLoader.getResource("C:\\Users\\236700\\Sample%20Project\\Active%20Directory%20-LDAP\\SpringSecurityDemo-master\\target\\classes\\private.key").getFile());
        File file = new File(classLoader.getResource("C:\\Users\\236700\\Sample Project\\Active Directory -LDAP\\SpringSecurityDemo-master\\src\\main\\resources\\private.key").getFile());
